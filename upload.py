...
csv_file_path ='D:/PROJECTS/Recomendation_System_FP/Code/cosin_similarity_registry/cosin_similarity_2024-01-19_v1.csv' #f"{configur.get('cosin_similarity_base_path','path')}cosin_similarity_{datetime.date.today()}.csv"
